...
The challenge here is that this application is fully scalable thanks to using background task and caching.
## Instructions
This application is fully containerized. To run the project go to the project's directory and run ***docker compose up***. This will expose the fastapi app im port 8000.
...
Instead of pip it would be a better approach to use poetry as dependency manager. As right now, in the Dockerfile everything is installed explicitly.
